...
![Zephyr](https://img.shields.io/badge/Zephyr-%23773C8C.svg?style=for-the-badge&logo=zephyr&logoColor=white)
...
- Hardware verification using OSVVM/UVVM and Cocotb frameworks
- FPGA synthesis and implementation via Vivado and Quartus toolchains

**Embedded Firmware & System Software**
- Low-latency firmware development for Arm-based embedded systems
- Kernel-level driver development and integration
- Real-time operating systems: VxWorks, Zephyr, FreeRTOS, and Linux
- Bare-metal programming and hardware abstraction layers (HAL)

**Application Development & Integration**
- Perception systems and computer vision using OpenCV
- GUI development with Qt framework
- SDK design and API development in C# and C++
- Build automation and CI/CD pipeline integration

**Verification & Automation**
- Hardware verification methodologies (OSVVM, UVVM, Cocotb)
- Test automation using Python and Tcl scripting
- Version control and collaborative development workflows (Git)
